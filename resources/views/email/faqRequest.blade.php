                                            ...
                                            <td style="padding-bottom:20px;padding-left:25px;padding-right:25px;padding-top:20px;">
                                                <div style="font-family: sans-serif">
                                                    <div style="font-size: 12px; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                                        <p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 36px;"><span style="font-size:20px;color:#6366f1;"><strong>Dear {{$success->username}}:</strong></span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div style="font-size: 12px; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                                        <p style="margin: 0; font-size: 14px; text-align: left;">
                                                            Thank you for contacting us. We have received your message and our team will review it shortly. We strive to respond to all inquiries as soon as possible.
                                                        </p>
                                                        <p style="margin: 0; font-size: 14px; text-align: left;">
                                                            Here is a preview of your message for your reference:<br><br>
                                                            {{$success->message_obj}}<br><br>
                                            ...
                                            <td>
                                                <div style="font-family: sans-serif">
                                                    <div style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: justify;"><br/><span style="font-size:14px;">Cordially,</span></p>
                                                        <p style="margin: 0; font-size: 14px; text-align: justify;"><br/><span style="font-size:14px;">Unlistened.me</span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td class="column" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 0px; padding-bottom: 0px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
                                    <table border="0" cellpadding="30" cellspacing="0" class="image_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                        <tr>
                                            <td>
                                                <div align="center" style="line-height:10px"><a href="https://www.unlistened.me/" style="outline:none" tabindex="-1" target="_blank"><img alt="unlistened.me logo" src="{{ asset('images/unlistened_transparen_logo_176.png') }}" style="display: block; height: auto; border: 0; width: 100px; max-width: 100%;" title="Unlistened.me logo" width="100"/></a></div>
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <td>
                                                <table align="center" border="0" cellpadding="0" cellspacing="0" class="social-table" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="138px">
                                                    <tr>
                                                        ...
                                                        <td style="padding:0 7px 0 7px;"><a href="https://x.com/unlistened_me" target="_blank"><img alt="twitter x" height="24" src="{{ asset('images/x-social-media-black-icon.png') }}" style="display: block; height: auto; border: 0;" title="twitter x" width="24"/></a></td>
                                                        <td style="padding:0 7px 0 7px;"><a href="https://github.com/Gian1984" target="_blank"><img alt="github" height="24" src="{{ asset('images/github-svgrepo-com.png') }}" style="display: block; height: auto; border: 0;" title="github" width="24"/></a></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
